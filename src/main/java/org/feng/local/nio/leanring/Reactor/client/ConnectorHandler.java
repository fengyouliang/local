...
public class ConnectorHandler implements Runnable {
    ...
    ConnectorHandler(SocketChannel socketChannel, Selector selector) throws IOException {
    ...
    private void read() throws IOException {
        if (selectionKey.isValid()) {
            ...
            System.out.printf("收到来自服务端的消息: %s%n", new String(readBuffer.array()));
